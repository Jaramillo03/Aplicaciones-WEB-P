			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>Marca:</strong> '.$rows['producto_codigo'].' <strong>Activo de Patrimonio:</strong> '.$rows['producto_precio'].' <strong>Activo de Tecnologias:</strong> '.$rows['producto_stock'].' <strong>Secretaria:</strong> '.$rows['categoria_nombre'].' <strong>Registrado por:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
